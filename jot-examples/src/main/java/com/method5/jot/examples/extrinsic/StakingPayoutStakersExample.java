...
public class StakingPayoutStakersExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (PolkadotRpcClient client = new PolkadotRpcClient(new String[] { ExampleConstants.RPC_SERVER }, 10000)) {
            ...
            // Build call data for Staking.payoutStakers
            byte[] callData = StakingPallet.payoutStakers(
                    client.getResolver(),
                    AccountId.fromSS58("114SUbKCXjmb9czpWTtS3JANSmNRwVa4mmsMrWYpRG1kDH5"), // validator stash public key
                    1872                                                                  // era to payout
            );
