...
public class StakingUnbondExample {
    private static final Logger logger = LoggerFactory.getLogger(StakingUnbondExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (PolkadotRpcClient client = new PolkadotRpcClient(new String[] { ExampleConstants.RPC_SERVER }, 10000)) {
            ...
            // Build call data for Staking.unbond
            byte[] callData = StakingPallet.unbond(
                    client.getResolver(),
