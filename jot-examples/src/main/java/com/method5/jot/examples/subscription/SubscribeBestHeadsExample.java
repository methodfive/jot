...
public class SubscribeBestHeadsExample extends ExampleBase {
    private static final Logger logger = LoggerFactory.getLogger(SubscribeBestHeadsExample.class);
    ...
    private static void execute(PolkadotWs api) throws Exception {
        logger.info("Subscribe Best Heads Example");
